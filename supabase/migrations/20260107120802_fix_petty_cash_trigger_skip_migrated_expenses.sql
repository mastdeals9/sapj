/*
  # Fix Petty Cash Trigger - Skip Migrated Expenses
  
  1. What This Does
    - Updates post_petty_cash_to_journal() trigger function
    - Adds 'migrated_from_expenses' to the list of sources that skip journal creation
  
  2. Purpose
    - Prevent double journal entries for expenses migrated from finance_expenses
    - Those expenses already have journal entries from the expense tracker
*/
