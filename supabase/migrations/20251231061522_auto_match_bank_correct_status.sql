...
/*
  # Auto-Match Bank Transactions - Correct Status Values

  1. Function
    - Fixed to use correct reconciliation_status values
    - 'matched' for high confidence
    - 'needs_review' for medium confidence
*/
